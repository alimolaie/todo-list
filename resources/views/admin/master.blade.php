...
<html lang="fa" dir="rtl">
  <head>
    ...
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/test/sweetalert2.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/test/toastr.min.css') }}">
  </head>
  ...
  <div class="page-wrapper">
   ...
   @yield('content')
    ...
    <script src="{{ asset('assets/test/toastr.min.js') }}"></script>
   <script>
